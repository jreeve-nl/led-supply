...
<Components>
  ...
  <SpicePar BRIDGE_PARAM 1 100 120 -29 15 0 0 "PI=3.1415927" 1 "V_PK_LINE={230 * sqrt(2)}V" 1 "V_AVG={V_PK_LINE * 2 / PI}V" 1 "P_LOAD=96.0W" 1 "R_LOAD={V_AVG^2 / P_LOAD}O" 1>
  ...
  <C C1 0 760 310 17 -26 0 1 "1000u" 1 "" 0 "neutral" 0>
  <.TR TR1 1 760 630 0 59 0 0 "lin" 1 "20 ms" 1 "40 ms" 1 "40001" 1 "Trapezoidal" 0 "2" 0 "1 ns" 0 "1e-16" 0 "150" 0 "0.001" 0 "1 pA" 0 "1 uV" 0 "26.85" 0 "1e-3" 0 "1e-6" 0 "1" 0 "CroutLU" 0 "no" 0 "yes" 0 "0" 0>
  <NutmegEq NutmegBridge 1 1020 490 -27 15 0 0 "tran" 1 "P_L_t=V(Pr1) * vpr4#branch" 1 "P_I_t=V(Pr5) * vpr2#branch" 1 "V_I_rms=sqrt(mean(V(Pr5)^2))" 1 "I_I_rms=sqrt(mean(vpr2#branch^2))" 1 "V_O_rms=sqrt(mean(V(Pr1)^2))" 1 "I_O_rms=sqrt(mean(vpr4#branch^2))" 1>
</Components>
<Wires>
